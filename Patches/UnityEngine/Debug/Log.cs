...
namespace Peroxide.Patches.UnityEngine.Debug
{
    ...
    {
        [HarmonyPatch(typeof(global::UnityEngine.Debug), "Log", new[] { typeof(object) })]
        ...
        [HarmonyPatch(typeof(global::UnityEngine.Debug), "Log", new[] { typeof(object), typeof(Object) })]
        [HarmonyPriority(Priority.First)]
    ...
    {
        [HarmonyPatch(typeof(global::UnityEngine.Debug), "LogFormat", new[] { typeof(string), typeof(object[]) })]
        [HarmonyPriority(Priority.First)]
        public static class LogObject
        {
        ...
        [HarmonyPatch(typeof(global::UnityEngine.Debug), "LogFormat", new[] { typeof(Object), typeof(string), typeof(object[]) })]
        [HarmonyPriority(Priority.First)]
        public static class LogContext
        {
            private static bool Prefix(Object context, string format, params object[] args)
            {
                Plugin.instance.Log.Log($"{string.Format(format, args)}\n{typeof(global::UnityEngine.Debug).FullName}:Log (object, {context.GetType().FullName})");
                return false;
            }
        }
    }
